    ...
    if (userDetails) {
      try {
        ...
        setUserData({
          ...
          automationsCreated: parsedUser.automationsCreated || 24,
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div className="space-y-1">
                    ...
                    <div className="bg-white dark:bg-gray-900 px-4 py-3 rounded-lg border border-gray-200 dark:border-gray-800 h-12">
                      {userData.name}
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="bg-white dark:bg-gray-900 px-4 py-3 rounded-lg border border-gray-200 dark:border-gray-800 font-medium h-12">
